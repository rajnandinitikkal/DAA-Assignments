...
Queue<KnapsackNode> queue = new
PriorityQueue<>(Comparator.comparingDouble(node -> -node.bound));
int n = items.length;
int bestValue = 0;
...
private static double getBound(int value, int weight, int level, Item[]
items, int maxWeight) {
double bound = value;
